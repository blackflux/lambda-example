...
// To catch all errors and log them without having to wrap all your functions, consider using blackflux/lambda-monitor
module.exports.logger = rollbar.wrap((event, context, rb) => {
